...
export class Service{
    ...
    async updatePost(slug,{title,content,featuredImage,status}){ //ama slug ne pela as a argument rakhyu che km k post ne update karva aek time ae aek j post joiye so aeni id madvi joiye jene apde slug thi identify karsu
